...
public class GoodsDetailController {
    ...
    @Autowired
    private SpecClient specParamClient;
    @Autowired
    ...
    public String item(@PathVariable("spuId") Long spuId,Model model){
        ...
        //6.参数中的规格参数
        List<SpecParam> specParamList=specParamClient.findParamsByCidGeneric(spuId,false);
        ...
        //1.导入templateEngine
        // 2.写入静态文件
        creatHtml(spu,spuDetail,skuList,specGroupList,categoryList,paramMap,brand);
    ...
    private void creatHtml(Spu spu, SpuDetail spuDetail, List<Sku> skuList, List<SpecGroup> specGroupList, List<Category> categoryList, Map<Long, String> paramMap, Brand brand) {
        ...
        try {
            ...
            //3.写入文件
            File file=new File("E:\\Users\\lenovo\\Downloads\\nginx-1.16.1\\nginx-1.16.1\\html"+spu.getId()+".html");
